...
export function GeofenceDetailClient({ 
  ...
  const handleMemberRemoved = () => {
    // Refresh members list - for now reload the page
    // In a more sophisticated implementation, we could optimistically update
        ...
        {isOwner && (
          <GeofenceSettingsModal
            ...
            onGeofenceUpdated={(updatedGeofence) => {
              ...
              // In a more sophisticated implementation, we could update local state
